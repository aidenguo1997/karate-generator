...
public class GeneratorScenarioScript {
    public StringBuilder generateScenarioKarateScript(OpenAPI openAPI, String gherkinContent, List<Map<String, String>> requestDataList) {
    ...
    private void handleOperation(StringBuilder karateScript, String path, Operation operation, String gherkinTag, List<Map<String, String>> requestDataList, String httpMethod) {
